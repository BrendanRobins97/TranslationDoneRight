...
namespace PSS
{
    ...
    public class TextImplementationExamples : MonoBehaviour
    {
        ...
        {
            return Translations.Format("Test sentence {0} 123", text);
        }

        private void Start()
        {
            // Example usage of various text implementations
            ...
            Debug.Log(GetRandomTip());
            Debug.Log(GetErrorMessage("save_failed".TranslateString()));
