...
namespace PSS
{
    ...
    {
        public static void SetTextTranslated(this TextMeshProUGUI tmpText, string key)
        {
        ...
        public static void SetTextTranslated(this TextMeshProUGUI tmpText, string format, params object[] args)
        {
            if (tmpText.GetComponent<TranslatedTMP>() == null)
            {
                tmpText.gameObject.AddComponent<TranslatedTMP>();   
