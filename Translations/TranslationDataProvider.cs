...
namespace PSS
{
    public static class TranslationDataProvider
    {
        ...
        public static string DefaultDataFolder => Path.Combine(DEFAULT_BASE_FOLDER, DATA_SUBFOLDER);
        public static string DefaultLanguagesFolder => Path.Combine(DEFAULT_BASE_FOLDER, LANGUAGES_SUBFOLDER);
        ...
        public static string DataFolder => Path.Combine(BaseFolder, DATA_SUBFOLDER);
        
        // Property to get the languages folder (where LanguageData assets are stored)
        public static string LanguagesFolder => Path.Combine(BaseFolder, LANGUAGES_SUBFOLDER);
        
        // Path to the main translation data asset
        private static string DataPath => Path.Combine(DataFolder, "TranslationData.asset");
        ...
        /// <summary>
        /// Load the TranslationMetadata asset from Resources or create a new one
        /// </summary>
        ...
        private static TranslationMetadata LoadOrCreateTranslationMetadata()
        {
            ...
            // Load from Resources
            var metadata = Resources.Load<TranslationMetadata>("TranslationMetadata");
        ...
        {
            return Path.Combine(LanguagesFolder, $"{languageCode}.asset");
        }
